...
export default class SelectedPosition extends Component {
  ...
  render(){
    ...
    if (selectedPosition){
      ...
      // CircleMarker extends Circle, they are the same, except the radius is
      // specified in pixels rather than in meters, so that the circles stay
      // constant size even if you zoom the map.
